...
public class Page2 extends AppCompatActivity {
    ...
    Resources res;
    ViewPager vp;
    com.example.joseph.beenavisionapp.CustomSwipeAdapter csa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        csa = new com.example.joseph.beenavisionapp.CustomSwipeAdapter(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.login_id:
                ...
                startActivity(new Intent(Page2.this, Logo.class).putExtra("key", "no"));
                break;
            default:
